...
import (
	...
	"gomicroddd/infrastructure/repository"
...
func main() {
	...
	membermepor := repository.Memberinfra{}
	memberapi := app.NewMemberApp(membermepor)
	queryid, _ := uuid.Parse("b4fcb682-f023-419f-9c5b-f67124da7256")
	model, err := memberapi.Get(queryid)
