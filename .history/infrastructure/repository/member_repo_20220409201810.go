...
import (
	...
	reflect "gomicroddd/infrastructure/utils/reflect"
...
func (m *MemberDomain) Get(ctx context.Context, uuid uuid.UUID) (*aggregate.Member, error) {
	...
	err = reflect.SetUnExportedStrField(r, "roles", roles)
	err = reflect.SetUnExportedStrField(r, "userRoleRelation", relations)
	if err != nil {
		return nil, err
	}
